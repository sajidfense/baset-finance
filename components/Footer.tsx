          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-6">
              <div className="relative w-10 h-10 brightness-0 invert opacity-80">
                <Image src="/logo.PNG" alt="Baset Finance" fill className="object-contain" />
              </div>
              <div>
            ...
            <p className="text-white/50 text-sm font-inter leading-relaxed mb-6">
              Trusted Australian mortgage brokers helping you secure smarter home loans with transparent advice.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex gap-3">
                ...
                <a href="tel:+61000000000" className="text-white/50 text-sm font-inter hover:text-gold transition-colors">
                  +61 (0) 000 000 000
                </a>
              </li>
              <li className="flex gap-3">
                <Mail size={16} className="text-gold mt-0.5 shrink-0" />
                <a href="mailto:info@basetfinance.com.au" className="text-white/50 text-sm font-inter hover:text-gold transition-colors">
                  info@basetfinance.com.au
                </a>
              </li>
              <li className="flex gap-3">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-white/30 text-xs font-inter">
              © {new Date().getFullYear()} Baset Finance. All rights reserved. Australian Credit Licence XXXXXX.
            </p>
